...
if sensitive_columns else "None detected"}
...
if REPORTLAB_AVAILABLE:
    ...
    st.success(
        "✅ Professional PDF report is ready."
    )
...
st.write(
    "Generate an automated analysis "
    "of your dataset."
)
